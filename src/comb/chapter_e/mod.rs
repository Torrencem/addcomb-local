    ...
    for m in 1.. {
        ...
        for a in each_set_exact(n, m) {
            if !a.hfoldintervalsumset((0, s), n).isfull(n) {
                info!("[chi] For m={}, found {}, which doesn't give a full sumset", m, a);
                info!("[chi] (gives:) {}", a.hfoldintervalsumset((0, s), n));
                found = true;
                break;
            }
        }
    ...
    for m in 1.. {
        ...
        for a in each_set_exact(n, m) {
            if !a.hfoldintervalsignedsumset((0, s), n).isfull(n) {
                info!("[chi] For m={}, found {}, which doesn't give a full sumset", m, a);
                info!("[chi] (gives:) {}", a.hfoldintervalsignedsumset((0, s), n));
                found = true;
                break;
            }
        }
    ...
    for m in 1.. {
        ...
        for a in each_set_exact(n, m) {
            if !a.hfoldintervalrestrictedsumset((0, s), n).isfull(n) {
                info!("[chi] For m={}, found {}, which doesn't give a full sumset", m, a);
                info!("[chi] (gives:) {}", a.hfoldintervalrestrictedsumset((0, s), n));
                found = true;
                break;
            }
        }
    ...
    for m in 1.. {
        ...
        for a in each_set_exact(n, m) {
            if !a.hfoldintervalrestrictedsignedsumset((0, s), n).isfull(n) {
                info!("[chi] For m={}, found {}, which doesn't give a full sumset", m, a);
                info!("[chi] (gives:) {}", a.hfoldintervalrestrictedsignedsumset((0, s), n));
                found = true;
                break;
            }
        }
